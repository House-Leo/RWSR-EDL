...
for test_loader in test_loaders:
    ...
    for data in test_loader:
        ...
        # sr_img_1 = util.tensor2img(visuals['SR_1'])
        # sr_img_2 = util.tensor2img(visuals['SR_2'])
        ...
        if suffix:
            ...
            # save_img_path_1 = osp.join(dataset_dir, img_name + '_1.png')
            # save_img_path_2 = osp.join(dataset_dir, img_name + '_2.png')
        util.save_img(sr_img, save_img_path)
        # util.save_img(sr_img_1, save_img_path_1)
        # util.save_img(sr_img_2, save_img_path_2)
